...
if __name__ == "__main__":
	...
	n_skies=file_len('/Users/emhuff/Projects/DarkWorlds/Data/Test_haloCounts.csv')-1 #The number of skies in total
	...
	nhalo=np.loadtxt('/Users/emhuff/Projects/DarkWorlds/Data/Test_haloCounts.csv',\
	...
	for k in xrange(n_skies):
		p=k+1
		x,y,e1,e2=np.loadtxt('/Users/emhuff/Projects/DarkWorlds/Data/Test_Skies/Test_Sky%i.csv' % p,\
